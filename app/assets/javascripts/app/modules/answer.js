...
function(app, Parking) {
  ...
  Answer.Views.Panel = Backbone.View.extend({
    ...
    beforeRender: function(){
      ...
      session = new Session()
      if ( !session.currentUser() && !(window.location.pathname == '/' || window.location.pathname == '/intro' || window.location.pathname == '/intro/big_picture' || window.location.pathname == '/intro/here_to_help' || window.location.pathname == '/intro/sign_in')) {
